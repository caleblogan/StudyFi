...
function Billboard() {
    ...
    return <div className="w-full h-[50vw] min-h-[420px] relative">
        <img
            ...
            src="https://i.ytimg.com/vi_webp/WL5XBs_ha3g/maxresdefault.webp" />
        <div className="bg-gradient-to-t from-gray-900 h-[200px] w-full bottom-[-6vw] left-0 absolute max-md:bottom-[0vw]">
        </div>
        <div className="flex flex-col justify-center h-full ml-8 relative pt-20">
            <h2 className="text-5xl max-sm:text-3xl">MOONRISE</h2>
            <h3 className="text-lg max-sm:text-md text-gray-300 ml-6">Lofi, Beats, and Study</h3>
            <div className="mt-4 flex gap-3">
                ...
                <p className="text-sm max-sm:text-xs">#8 in Balcony Lofi Today</p>
            </div>
            <p className="max-w-[398px] mt-6 text-sm max-sm:text-xs">
                From the lofty perch of a skyscraper balcony in Panama City, overlook the bustling streets below, where life unfolds in a mesmerizing rhythm. Down there, amidst the colorful murals and the soft jazz tunes drifting from nearby cafes, the city pulses with energy.
            </p>
            <div className="mt-4">
                <Button
