...
function Billboard() {
    ...
    return <div className="w-full h-[50vw] min-h-[420px] relative">
        ...
        <div className="flex flex-col justify-center h-full ml-8 relative pt-20">
            <h2 className="text-5xl max-sm:text-3xl">THE PROGRAM</h2>
            <h3 className="text-lg max-sm:text-md text-gray-300 ml-6">Cons, Cults, and Kidnapping</h3>
            <div className="mt-4 flex gap-3">
                ...
                <p className="text-sm max-sm:text-xs">#8 in TV Shows Today</p>
            </div>
